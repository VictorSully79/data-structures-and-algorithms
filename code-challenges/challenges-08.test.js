...
function returnTen(str){
  ...
  // //sliceAndDice.push(splitResult.slice(6));
  // moreSlappy.push(slapChop.slice(1));
  // console.log('this is splitresult', moreSlappy);
  // //console.log('this is sliceAndDice', sliceAndDice);
